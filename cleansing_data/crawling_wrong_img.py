...
with SSHTunnelForwarder(
    ...
    wrong_img_query = "SELECT id, company, transact_date, lot, img, auction_name FROM solution_yeolmae.crawling WHERE img NOT LIKE '%https://new-auction-solution.s3.ap-northeast-2.amazonaws.com%' AND img LIKE 'http%';"
    ...
    for i in range(0, len(df), batch_size):
        ...
        for index, row in batch_df.iterrows():
            query = f"UPDATE crawling SET img = '{row['img']}' WHERE id = {row['id']}"
